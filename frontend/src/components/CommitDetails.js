...
const CommitDetails = ({ commitData }) => {
  ...
  return (
    <div className="grid bg-white shadow-lg rounded-lg p-5 my-5">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-block bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mt-3"
      >
